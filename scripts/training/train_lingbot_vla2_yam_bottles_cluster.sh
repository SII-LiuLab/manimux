...
mode=${1:-train}
run_name=${2:-put-bottles-lingbot-vla2-joint-ee-native-depth-8xh100-b64-30k}
...
export LINGBOT_VLA2_MAX_STEPS=${LINGBOT_VLA2_MAX_STEPS:-30000}
export LINGBOT_VLA2_SAVE_STEPS=${LINGBOT_VLA2_SAVE_STEPS:-5000}
