...
mode=${1:-train}
run_name=${2:-assemble-screwdriver-lingbot-joint-ee-native-depth-8xh100-b64-15k}

export LINGBOT_VLA2_DATASET_PATH=${LINGBOT_VLA2_DATASET_PATH:-${ROOT}/datasets/lerobot/yam_assemble_screwdriver_20260825_v1_joint_ee}
export LINGBOT_VLA2_DATASET_NAME=${LINGBOT_VLA2_DATASET_NAME:-yam_assemble_screwdriver_20260825_v1_joint_ee}
