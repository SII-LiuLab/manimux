...
旧 `robots/` 导入目录已删除；工厂位于 `embodiments.robot`，Tianji 和 YAM 均使用组件装配。
...
| `manimux/configs/embodiment/sensor/taccap.yaml` | 相机采集参数 |
...
robot = TianjiTaccapRobot.from_config("manimux/configs/embodiment/robot/tianji_taccap.yaml")
