...
from manimux.integrations.xr1_tianji_taccap.policy_plugin import (
    ACTION_DIM,
...
EXPERIMENT = (
    ROOT / "configs/xiaomi-xr1/tianji-taccap/infra/pass_ball/manimux.yaml"
)


class FakeManipulator:
    def __init__(self, *, fail=False):
        self.arm = SimpleNamespace(max_step_duration_s=None)
        self.fail = fail
        self.targets = []
