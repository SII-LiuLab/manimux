...
- `viewer/robots/{tianji,yam}/viewer.yaml`: model reference, group display placement,
  table, stand, view, colors, initial pose selection and camera panels. Initial/demo
...
`manimux/configs/embodiment/robot/tianji_taccap.yaml`. These are the active joint values
