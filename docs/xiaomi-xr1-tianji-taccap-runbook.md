...
- 模型服务：`configs/xiaomi-xr1/tianji-taccap/server/pass_ball/step50000.yaml`
- 安全关闭执行的实验模板：
  `configs/xiaomi-xr1/tianji-taccap/infra/pass_ball/manimux.yaml`
- server launcher：`scripts/servers/xiaomi_xr1_tianji_server.py`
...
```bash
cd /home/jw/Desktop/project/manimux/XPolicyLab/policy/Xiaomi_Robotics_1
...
/home/jw/miniforge3/envs/mibot/bin/python \
  scripts/servers/xiaomi_xr1_tianji_server.py \
  --experiment configs/xiaomi-xr1/tianji-taccap/infra/pass_ball/manimux.yaml \
  --local .local/tianji_taccap.yaml \
  --checkpoint /home/jw/Downloads/posttrain_pass_ball_50k_8gpu_epoch0_step50000_checkpoint \
  --check
```
...
```bash
/home/jw/miniforge3/envs/xense-taccap/bin/python -m manimux run \
  --config configs/xiaomi-xr1/tianji-taccap/infra/pass_ball/manimux.yaml \
  --local .local/tianji_taccap.yaml
```
