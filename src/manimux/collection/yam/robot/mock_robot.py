...
class MockRobot(RobotInterface):
    def __init__(self, num_arm_joints: int = 6):
        ...
        self._feedback_timestamp_ns = time.time_ns()
    ...
    def get_observations(self) -> dict[str, np.ndarray]:
        ...
        return {
            ...
            "feedback_timestamp_ns": np.int64(self._feedback_timestamp_ns),
        }
    ...
    def get_controller_input(self):
        if self._controller_input is None:
            return None
        return {
            "joint_pos": self._controller_input["joint_pos"].copy(),
            "timestamp_ns": np.int64(self._controller_input["timestamp_ns"]),
        }
